...
/**
 * Fig. 7.24: ArrayListCollection.java <br>
...
public class ArrayListCollection {
    /**
     * main method for demonstrating the ArrayList class
     */
     ...
     * @param items Strings to print
     * @param header String to print before items
     */
